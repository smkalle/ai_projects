...
app = FastAPI(title="GreenGuard - Enhanced Multi-Agent System with Progress Logs")
...
async def datascout_agent(state: GreenGuardState) -> GreenGuardState:
    ...
    try:
        ...
        await broadcast_workflow_update({
            "type": "agent_start",
            "agent": "DataScout",
            "status": "Initializing environmental data search...",
            "progress": 10
        })
...
async def read_root():
    ...
    <head>
        ...
        <title>GreenGuard - Enhanced Multi-Agent System</title>
    ...
    <body>
        ...
        <main class="main-container">
            <section class="hero-section">
                <h1 class="hero-title">Enhanced AI Environmental Protection</h1>
                <p class="hero-subtitle">Complete multi-agent system with detailed progress tracking</p>
            </section>
                ...
                <div class="log-content" id="log-content">
                    <div class="log-body" id="log-body">
                        <div class="log-entry">
                            ...
                            <div class="log-activity">Waiting for workflow to start...</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            function addLogEntry(logEntry) {
                ...
                // Clear the initial waiting message if this is the first real entry
            ...
            function resetWorkflowUI() {
                ...
                logBody.innerHTML = `
                    <div class="log-entry">
                        <div class="log-timestamp">00:00:00</div>
                        <div class="log-agent">System</div>
                        <div class="log-activity">Workflow starting...</div>
                    </div>
                `;
